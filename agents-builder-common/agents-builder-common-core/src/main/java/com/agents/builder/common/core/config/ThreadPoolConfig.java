...
import com.agents.builder.common.core.config.properties.ThreadPoolProperties;
import com.agents.builder.common.core.utils.Threads;
...
public class ThreadPoolConfig {
    ...
    @Bean("mvcExecutor")
    public ThreadPoolTaskExecutor mvcExecutor() {
        ThreadPoolTaskExecutor executor = new ThreadPoolTaskExecutor();
        executor.setCorePoolSize(core);
        executor.setMaxPoolSize(core * 2);
    ...
    public ThreadPoolTaskExecutor workFlowExecutor() {
        ...
        executor.setKeepAliveSeconds(60);
        executor.setThreadNamePrefix("work-flow-");
        executor.setRejectedExecutionHandler(new ThreadPoolExecutor.CallerRunsPolicy());
        return executor;
    }
