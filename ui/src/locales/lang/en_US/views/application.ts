  ...
  applicationForm: {
    ...
    form: {
      ...
      appDescription: {
        ...
        placeholder:
          'Describe the application scenario and use, e.g.: AI App Builder assistant answering user questions about AI App Builder product usage'
      },
      aiModel: {
        label: 'AI Model',
    ...
    dialogues: {
      ...
      designated_answer:
        'Hello, I am AI App Builder Assistant. My knowledge base only contains information related to AI App Builder products. Please rephrase your question.'
    }
  },
  prompt: {
    defaultPrompt:
    ...
    defaultPrologue:
      'Hello, I am AI App Builder Assistant. You can ask me questions about using AI App Builder.\n- What are the main features of AI App Builder?\n- Which large language models does AI App Builder support?\n- What document types does AI App Builder support?'
  }
}
